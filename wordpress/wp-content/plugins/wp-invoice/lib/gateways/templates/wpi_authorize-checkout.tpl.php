<!-- AUTHORIZE.NET -->
<form method="POST" class="<?php echo apply_filters('wpi_spc::form_class', "wpi_checkout {$gateway_key}"); ?>" action="#" <?php echo $display ? '' : 'style="display:none;"'; ?>>
...
<?php foreach($wpi_checkout['info_block'] as $info_block => $block_data): ?>
        <ul class="wpi_checkout_block wpi_checkout_<?php echo $info_block; ?>">
          <li class="section_title"><?php echo ucwords(str_replace("_", " ", $info_block)); ?></li>
