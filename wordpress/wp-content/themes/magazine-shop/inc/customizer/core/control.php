 ...
 */
class Magazine_Shop_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Magazine_Shop_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Magazine_Shop_Customize_Section_Upsell extends WP_Customize_Section {
