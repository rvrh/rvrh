...
$wp_customize->add_section( 'theme_option_section_settings',
	array(
		'title'      => esc_html__( 'Layout Management', 'magazine-shop' ),
		'priority'   => 100,
		'capability' => 'edit_theme_options',
...
$wp_customize->add_control( 'home_page_content_status',
	array(
		'label'    => esc_html__( 'Enable Static Page Content', 'magazine-shop' ),
...
$wp_customize->add_control( 'enable_overlay_option',
	array(
		'label'    => esc_html__( 'Enable Banner Overlay', 'magazine-shop' ),
...
$wp_customize->add_control( 'global_layout',
	array(
		'label'    => esc_html__( 'Global Layout', 'magazine-shop' ),
		'section'  => 'theme_option_section_settings',
		'choices'               => array(
                'right-sidebar' => esc_html__( 'Content - Primary Sidebar', 'magazine-shop' ),
                'left-sidebar' => esc_html__( 'Primary Sidebar - Content', 'magazine-shop' ),
                'no-sidebar' => esc_html__( 'No Sidebar', 'magazine-shop' )
		    ),
		'type'     => 'select',
		'priority' => 170,
	)
...
$wp_customize->add_setting( 'excerpt_length_global',
	array(
		...
		'capability'        => 'edit_theme_options',
		'sanitize_callback' => 'magazine_shop_sanitize_positive_integer',
	)
);
$wp_customize->add_control( 'excerpt_length_global',
	array(
		'label'    => esc_html__( 'Set Global Archive Length', 'magazine-shop' ),
		'section'  => 'theme_option_section_settings',
		'type'     => 'number',
		'priority' => 175,
...
$wp_customize->add_control( 'read_more_button_text',
    array(
        'label'    => esc_html__( 'Read More Button Text', 'magazine-shop' ),
        'section'  => 'theme_option_section_settings',
        'type'     => 'text',
        'priority' => 175,
    )
...
$wp_customize->add_control( 'archive_layout',
	array(
		'label'    => esc_html__( 'Archive Layout', 'magazine-shop' ),
		'section'  => 'theme_option_section_settings',
		'choices'               => array(
			'excerpt-only' => esc_html__( 'Excerpt Only', 'magazine-shop' ),
			'full-post' => esc_html__( 'Full Post', 'magazine-shop' ),
		    ),
		'type'     => 'select',
		'priority' => 180,
	)
...
$wp_customize->add_control( 'archive_layout_image',
	array(
		'label'    => esc_html__( 'Archive Image Alocation', 'magazine-shop' ),
		'section'  => 'theme_option_section_settings',
		'choices'               => array(
			'full' => esc_html__( 'Full', 'magazine-shop' ),
			'right' => esc_html__( 'Right', 'magazine-shop' ),
			'left' => esc_html__( 'Left', 'magazine-shop' ),
			'no-image' => esc_html__( 'No image', 'magazine-shop' )
		    ),
		'type'     => 'select',
		'priority' => 185,
	)
...
$wp_customize->add_control( 'single_post_image_layout',
	array(
		'label'    => esc_html__( 'Single Post/Page Image Alocation', 'magazine-shop' ),
		'section'  => 'theme_option_section_settings',
		'choices'               => array(
			'full' => esc_html__( 'Full', 'magazine-shop' ),
			'right' => esc_html__( 'Right', 'magazine-shop' ),
...
$wp_customize->add_section( 'pagination_section',
	array(
	'title'      => esc_html__( 'Pagination Options', 'magazine-shop' ),
	'priority'   => 110,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'pagination_type',
	array(
	'label'       => esc_html__( 'Pagination Type', 'magazine-shop' ),
	'section'     => 'pagination_section',
	'type'        => 'select',
	'choices'               => array(
		'default' => esc_html__( 'Default (Older / Newer Post)', 'magazine-shop' ),
		'numeric' => esc_html__( 'Numeric', 'magazine-shop' ),
	    ),
	'priority'    => 100,
	)
);
...
$wp_customize->add_section( 'footer_section',
	array(
	'title'      => esc_html__( 'Footer Options', 'magazine-shop' ),
	'priority'   => 130,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'number_of_footer_widget',
	array(
	'label'    => esc_html__( 'Number Of Footer Widget', 'magazine-shop' ),
	'section'  => 'footer_section',
	'type'     => 'select',
	'priority' => 100,
	'choices'               => array(
		0 => esc_html__( 'Disable footer sidebar area', 'magazine-shop' ),
		1 => esc_html__( '1', 'magazine-shop' ),
		2 => esc_html__( '2', 'magazine-shop' ),
		3 => esc_html__( '3', 'magazine-shop' ),
	    ),
	)
);
...
$wp_customize->add_control( 'copyright_text',
	array(
	'label'    => esc_html__( 'Footer Copyright Text', 'magazine-shop' ),
	'section'  => 'footer_section',
	'type'     => 'text',
	'priority' => 120,
	)
...
$wp_customize->add_section( 'breadcrumb_section',
	array(
	'title'      => esc_html__( 'Breadcrumb Options', 'magazine-shop' ),
	'priority'   => 120,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'breadcrumb_type',
	array(
	'label'       => esc_html__( 'Breadcrumb Type', 'magazine-shop' ),
	'description' => sprintf( esc_html__( 'Advanced: Requires %1$sBreadcrumb NavXT%2$s plugin', 'magazine-shop' ), '<a href="https://wordpress.org/plugins/breadcrumb-navxt/" target="_blank">','</a>' ),
	'section'     => 'breadcrumb_section',
	'type'        => 'select',
	'choices'               => array(
		'disabled' => esc_html__( 'Disabled', 'magazine-shop' ),
		'simple' => esc_html__( 'Simple', 'magazine-shop' ),
		'advanced' => esc_html__( 'Advanced', 'magazine-shop' ),
	    ),
	'priority'    => 100,
	)
);
...
$wp_customize->add_section( 'preloader_section',
	array(
	'title'      => esc_html__( 'Preloader Options', 'magazine-shop' ),
	'priority'   => 125,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'enable_preloader_option',
	array(
		'label'    => esc_html__( 'Enable Preloader', 'magazine-shop' ),
