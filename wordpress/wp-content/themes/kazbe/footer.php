...
?>
	...
	<?php if( is_front_page() ): ?>
		...
		<?php if( 'no' != get_theme_mod('kazbe_show_social') ): ?>
	...
	<footer id="colophon" class="site-footer">
		...
		<div class="site-logo">
			...
			?>
			<p><?php esc_html_e( 'All rights reserved.', 'kazbe' ); ?></p>
			...
			<?php if ( dynamic_sidebar('footer-left') ){ } else { ?>
				...
				<section class="widget">
					...
					<div class="widgetContainerInner">
						...
						<h2 class="widget-title"><span><?php _e( 'Pages', 'kazbe' ); ?></span></h2>
                        <ul>
			...
			<?php if ( dynamic_sidebar('footer-middle') ){ } else { ?>
				...
				<section class="widget">
					...
					<div class="widgetContainerInner">
						...
						<h2 class="widget-title"><span><?php _e( 'Meta', 'kazbe' ); ?></span></h2>
                        <ul>
                            <?php wp_register(); ?>
			...
			<?php if ( dynamic_sidebar('footer-right') ){ } else { ?>
				...
				<section class="widget">
					...
					<div class="widgetContainerInner">
						...
						<h2 class="widget-title"><span><?php _e( 'Archives', 'kazbe' ); ?></span></h2>
                        <ul>
